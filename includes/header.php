...
<li class="nav-item">
        ...
        <!-- Sales -->
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle <?= nav_active_any(['invoice.php','invoice_list.php','invoice_enhanced.php','invoice_list_enhanced.php','returns.php'],$path) ?>"
             href="#" data-bs-toggle="dropdown">
            <i class="bi bi-receipt me-1"></i>Sales
          </a>
          <ul class="dropdown-menu">
            <li class="dropdown-header">Enhanced Invoice System</li>
            <li><a class="dropdown-item <?= nav_active('invoice_enhanced.php',$path) ?>" href="<?= $base ?>/invoice_enhanced.php">
              <i class="bi bi-plus-circle me-2"></i>Create Invoice
            </a></li>
            <li><a class="dropdown-item <?= nav_active('invoice_list_enhanced.php',$path) ?>" href="<?= $base ?>/invoice_list_enhanced.php">
              <i class="bi bi-list-ul me-2"></i>Invoice List
            </a></li>
            <li><hr class="dropdown-divider"></li>
            <li class="dropdown-header">Legacy System</li>
            <li><a class="dropdown-item <?= nav_active('invoice.php',$path) ?>" href="<?= $base ?>/invoice.php">Legacy New Invoice</a></li>
            <li><a class="dropdown-item <?= nav_active('invoice_list.php',$path) ?>" href="<?= $base ?>/invoice_list.php">Legacy Invoice List</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item <?= nav_active('returns.php',$path) ?>" href="<?= $base ?>/returns.php">
 ...
 <!-- Commission & Earnings -->
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item <?= nav_active('report_inventory_enhanced.php',$path) ?>" href="<?= $base ?>/report_inventory_enhanced.php"><i class="bi bi-boxes"></i> Enhanced Inventory Report</a></li>
            <li><a class="dropdown-item <?= nav_active('report_commission_enhanced.php',$path) ?>" href="<?= $base ?>/report_commission_enhanced.php"><i class="bi bi-person-check"></i> Enhanced Commission Report</a></li>
