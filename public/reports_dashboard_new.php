...
<div class="container-fluid mt-4">
    ...
    <div class="category-header">
        <h4><i class="bi bi-calculator"></i> Profit & Loss Analysis</h4>
        <p class="mb-0">Comprehensive profit analysis with quotation, invoice, and item-wise breakdowns</p>
    </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            <div class="card report-card h-100" onclick="location.href='report_profit_loss.php'">
                <div class="card-body text-center">
                    <i class="bi bi-calculator report-icon"></i>
                    <h5>Advanced P&L Analysis</h5>
                    <p class="text-muted">Quotation, invoice, and item-wise profit analysis with commission tracking</p>
                    <?php if ($can_view_pl): ?>
                        <span class="badge bg-success permission-badge">Accessible</span>
                    <?php else: ?>
                        <span class="badge bg-warning permission-badge">Restricted</span>
